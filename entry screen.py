...
class EntryScreen(arcade.View):
    ...
    def on_draw(self):
        arcade.start_render()
        arcade.draw_text("Application:", start_x=20, start_y=600, color=arcade.color.BLACK, font_size=20)
        arcade.draw_text("URL:", start_x=20, start_y=500, color=arcade.color.BLACK, font_size=20)
        arcade.draw_text("Username:", start_x=20, start_y=400, color=arcade.color.BLACK, font_size=20)
        arcade.draw_text("Password:", start_x=20, start_y=300, color=arcade.color.BLACK, font_size=20)
    ...
    def setup(self):
        ...
        # input box application
        input_box = arcade.gui.UIInputBox(center_x=270, center_y=620, width=245)
        input_box.text = ''
